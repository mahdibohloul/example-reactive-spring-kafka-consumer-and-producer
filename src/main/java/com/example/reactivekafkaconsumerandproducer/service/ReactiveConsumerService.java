...
public class ReactiveConsumerService implements CommandLineRunner {
    ...
    public ReactiveConsumerService(
            ReactiveKafkaConsumerTemplate<String, FakeConsumerDTO> reactiveKafkaConsumerTemplate) {
        this.reactiveKafkaConsumerTemplate = reactiveKafkaConsumerTemplate;
    }

    public Mono<FakeConsumerDTO> consumeFakeConsumerDTO() {
        return reactiveKafkaConsumerTemplate
                ...
                .doOnNext(fakeConsumerDTO -> log.info("successfully consumed {}={}",
                        FakeConsumerDTO.class.getSimpleName(), fakeConsumerDTO))
                .doOnError(
